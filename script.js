...
function change() {
  ...
  document.querySelector(`.btn${btntext[randomtext]}`).textContent =
  ...
  document.querySelector(`.btn${btncolor[randomcolor]}`).style.color =
    colors[color];
        ...
        onComplete: () => {
          ...
          id = setInterval(() => {
            ...
            if (time == -1) {
              ...
              document.querySelector(".result .restart").style.display =
                "block";
            }
          }, 1000);
        },
